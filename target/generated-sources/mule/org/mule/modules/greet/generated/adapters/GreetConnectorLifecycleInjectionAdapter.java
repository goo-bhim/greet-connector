...
/**
 * A <code>GreetConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link GreetConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-04-26T10:11:41-07:00", comments = "Build UNNAMED.2793.f49b6c7")
public class GreetConnectorLifecycleInjectionAdapter
    extends GreetConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(GreetConnectorLifecycleInjectionAdapter.class);
